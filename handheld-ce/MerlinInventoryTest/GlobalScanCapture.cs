...
{
    /// <summary>
    /// Captures keyboard-wedge scans at the application level so the gun can scan
    /// without the user tapping a text field first. Disabled while a typing field has focus.
    /// </summary>
